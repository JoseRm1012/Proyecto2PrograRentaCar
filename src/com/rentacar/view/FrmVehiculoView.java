 ...
 * @author Jon
 */
public class FrmVehiculoView extends javax.swing.JDialog {
     ...
     */
    public FrmVehiculoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVehiculoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmVehiculoView dialog = new FrmVehiculoView(new java.awt.Frame(), true);
